            ...
            <div className="product-pic col-lg-6">
              ...
              <div className="other-pic mt-2 ">
                <div className="row g-2 d-flex justify-content-around ">
                  <img
                    src="/product/product-test.jpg"
                    alt="..."
                    onClick={() =>
                      handleImageClick("/product/product-test.jpg")
                    }
                  ></img>
                  <img
                    src="/product/product-test2.jpg"
                    alt="..."
                    onClick={() =>
                      handleImageClick("/product/product-test2.jpg")
                    }
                  ></img>
                  <img
                    src="/product/product-test3.jpg"
                    alt="..."
                    onClick={() =>
                      handleImageClick("/product/product-test3.jpg")
                    }
                  ></img>
                  <img
                    src="/product/product-test4.jpg"
                    alt="..."
                    onClick={() =>
                      handleImageClick("/product/product-test4.jpg")
                    }
                  ></img>
                </div>
              </div>
          ...
          <section className="product-detail-tabs d-flex justify-content-center">
            <ul className="nav nav-underline d-flex w-100 justify-content-around ">
              <li className="nav-item1">
                <a
                  className={`nav-link size-6 ${
                    activeSection === "product-description" ? "active" : ""
                  }`}
                  aria-current="page"
              ...
              <li className="nav-item2">
                <a
                  className={`nav-link size-6 ${
                    activeSection === "customer-message" ? "active" : ""
                  }`}
                  aria-current="page"
