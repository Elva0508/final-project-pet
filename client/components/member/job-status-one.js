...
export default function JobStatusTwo({job}) {
  ...
  const currentData = job.slice(startIndex, endIndex);
  ...
  return (
    <>
      ...
      <Pagination  itemsPerPage={itemsPerPage} total={job} activePage={activePage} setActivePage={setActivePage}/>
    </>
  );
}
