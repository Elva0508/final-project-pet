...
export default function JobStatusTwo({norecord}) {
  ...
  const currentData = norecord.slice(startIndex, endIndex);
  ...
  return (
    <>
      ...
      <Pagination  itemsPerPage={itemsPerPage} total={norecord} activePage={activePage} setActivePage={setActivePage}/>
    </>
  );
}
