...
export default function JobStatusTwo({close}) {
  ...
  const currentData = close.slice(startIndex, endIndex);
  ...
  return (
    <>
      ...
      <Pagination  itemsPerPage={itemsPerPage} total={close} activePage={activePage} setActivePage={setActivePage}/>
    </>
  );
}
